# -*- coding: utf-8 -*-
"""
Created on Wed Jan 28 17:17:17 2026
...
plt.subplot(2, 2, 2)
plt.plot(tall, comb2_cs, zorder=1)                 # line first (background)
plt.scatter(t, Theta2, c='red', zorder=2) 
plt.ylim(-np.pi, np.pi)
plt.xlabel(r"$t(s)$")
plt.ylabel(r"$\theta_2(rad)$")
...
plt.subplot(2, 2, 4)
plt.plot(tall, comb4_cs, zorder=1)                 # line first (background)
plt.scatter(t, D4, c='red', zorder=2) 
plt.xlabel(r"$t(s)$")
plt.ylabel(r"$d_4(cm)$")
plt.xlim(0, delta_t * 11)
...
vel2_cs = np.gradient(comb2_cs,tall)
acc2_cs = np.gradient(vel2_cs,tall)


vel4_cs = np.gradient(comb4_cs,tall)
acc4_cs = np.gradient(vel4_cs,tall)
vel4_cs = np.gradient(comb4_cs,tall)
acc4_cs = np.gradient(vel4_cs,tall)
...
plt.subplot(2, 2, 3)
plt.plot(tall,vel4_cs, zorder = 1)
...
plt.subplot(2, 2, 2)
plt.plot(tall,vel2_cs, zorder = 1)
#plt.scatter(t,vel2_sampled, c='red', zorder=2) 
plt.xlabel(r"$t(s)$")
plt.ylabel(r"$\dot{\theta}_2(rad/s)$")
plt.xlim(0, delta_t * 11)
...
plt.subplot(2, 2, 3)
plt.plot(tall,acc4_cs, zorder = 1)
#plt.scatter(t,vel4_sampled, c='red', zorder=2) 
plt.xlabel(r"$t(s)$")
plt.ylabel(r"$\dot{d}_4(cm/s)$")
plt.xlim(0, delta_t * 11)
...
plt.subplot(2, 2, 2)
plt.plot(tall,acc2_cs, zorder = 1)
#plt.scatter(t,vel2_sampled, c='red', zorder=2) 
plt.xlabel(r"$t(s)$")
plt.ylabel(r"$\dot{\theta}_2(rad/s)$")
plt.xlim(0, delta_t * 11)
